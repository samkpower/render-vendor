...
const DEFAULT_BOOT_OPTIONS = { executablePath: '/usr/bin/google-chrome' }; // use puppeteer defaults, https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md#puppeteerlaunchoptions
