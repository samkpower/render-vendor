...
const DEFAULT_BOOT_OPTIONS = { product: 'firefox', headless: false }; // use puppeteer defaults, https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md#puppeteerlaunchoptions
